					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								...
								<p><a href="{{url('/aboutus')}}" class="btn btn-secondary me-2">About Us</a></p>
							</div>
						</div>
						<div class="col-lg-7">
				...
				<div class="row">
					...
					@foreach ($blogs as $blog)
						...
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="/blogimage/{{$blog->image}}" alt="Image" class="img-fluid"></a>
							<div class="post-content-entry">
								<h3><a href="#">{{$blog->title}}</a></h3>
								<div class="meta">
									<span>by <a href="#">{{$blog->name}}</a></span> <span>on <a href="#">{{$blog->created_at->format('M j, Y')}}</a></span>
								</div>
							</div>
						</div>
					</div>
