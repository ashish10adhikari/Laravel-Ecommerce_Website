    ...
    <div class="d-flex">
        ...
        <div class="content-wrapper" style="align-items:flex-start; padding-top:50px;">
            <div style="width:100%; text-align:center; ">
                <h1>Update Blog </h1>
                <form action="{{ route('updatetheblog',$updateblog->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div style="display: flex; justify-content:space-evenly;">
                        <div>
                            <label for="">Name:</label> <input type="text" name="name" value="{{$updateblog->name}}">
                        </div>
                        ...
                        <div>
                            <label for="">Current Image:</label> <img style="height: 100px; width:100px;" src="/blogimage/{{$updateblog->image}}" alt="">
                        </div>
